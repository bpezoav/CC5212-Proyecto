...
# Contamos la cantidad de comentarios por sentimiento
most_common_sentiment = df.groupBy('sentiment').agg(count('body').alias('comment_count'))
most_common_sentiment.write.csv(fileout)